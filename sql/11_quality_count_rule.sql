-- =====================================================================
-- zing-doctor 医生系统 - 质控「指标规则层」增量脚本（达梦 DM8）
--
...
COMMENT ON COLUMN "zing_doctor_db_prod"."quality_count_rule"."target_value"       IS '本院自管目标值（ICU 侧未配）';
COMMENT ON COLUMN "zing_doctor_db_prod"."quality_count_rule"."warning_value"      IS '本院自管预警值（ICU 侧未配）';
