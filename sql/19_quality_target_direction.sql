...
BEGIN
  ...
  IF v_cnt = 0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE "zing_doctor_db_prod"."quality_count_rule" ADD COLUMN "target_direction" VARCHAR(16) DEFAULT ''UP''';
  END IF;
END;
/
...
UPDATE "zing_doctor_db_prod"."quality_count_rule"
