...
ALTER TABLE "zing_doctor_db_prod"."apache2_score_record" ADD COLUMN "pdf_data" TEXT;
ALTER TABLE "zing_doctor_db_prod"."apache2_score_record" ADD COLUMN "pdf_name" VARCHAR(200);
