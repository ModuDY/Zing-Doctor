...
INSERT INTO "zing_doctor_db_prod"."config_ddd"
...
FROM DUAL
WHERE NOT EXISTS (
    SELECT 1 FROM "zing_doctor_db_prod"."config_ddd"
...
INSERT INTO "zing_doctor_db_prod"."config_mdro"
...
FROM DUAL
WHERE NOT EXISTS (
    SELECT 1 FROM "zing_doctor_db_prod"."config_mdro"
...
INSERT INTO "zing_doctor_db_prod"."config_abx_word"
    ("word_type", "keyword", "category", "remark")
SELECT 'broad_spectrum', '哌拉西林', '广谱抗菌药', '内置默认'
FROM DUAL
WHERE NOT EXISTS (
    SELECT 1 FROM "zing_doctor_db_prod"."config_abx_word"
...
-- 监护item_code配置
INSERT INTO "zing_doctor_db_prod"."config_apache2"
...
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM "zing_doctor_db_prod"."config_apache2" WHERE "config_type"='observe_item' AND "config_key"='temperature');

INSERT INTO "zing_doctor_db_prod"."config_apache2"
    ("config_type", "config_key", "config_value", "item_name", "remark", "sort_no")
SELECT 'observe_item', 'heart_rate', 'oi_hr', '心率', '心率监护item_code，可配置', 2
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM "zing_doctor_db_prod"."config_apache2" WHERE "config_type"='observe_item' AND "config_key"='heart_rate');

INSERT INTO "zing_doctor_db_prod"."config_apache2"
    ("config_type", "config_key", "config_value", "item_name", "remark", "sort_no")
SELECT 'observe_item', 'respiratory_rate', 'oi_hxpl', '呼吸频率', '实际呼吸频率监护item_code，可配置', 3
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM "zing_doctor_db_prod"."config_apache2" WHERE "config_type"='observe_item' AND "config_key"='respiratory_rate');

INSERT INTO "zing_doctor_db_prod"."config_apache2"
    ("config_type", "config_key", "config_value", "item_name", "remark", "sort_no")
SELECT 'observe_item', 'map', 'oi_ycpjy,oi_pjy', '平均动脉压', 'MAP监护item_code，优先有创(oi_ycpjy)，多个用逗号分隔', 4
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM "zing_doctor_db_prod"."config_apache2" WHERE "config_type"='observe_item' AND "config_key"='map');

INSERT INTO "zing_doctor_db_prod"."config_apache2"
    ("config_type", "config_key", "config_value", "item_name", "remark", "sort_no")
SELECT 'observe_item', 'fio2', 'oi_FiO2(设置值)', 'FiO2', '吸氧浓度监护item_code', 5
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM "zing_doctor_db_prod"."config_apache2" WHERE "config_type"='observe_item' AND "config_key"='fio2');

-- 检验lis_item_code配置
INSERT INTO "zing_doctor_db_prod"."config_apache2"
    ("config_type", "config_key", "config_value", "item_name", "remark", "sort_no")
SELECT 'lis_item', 'sodium', '100150,5039', '血清钠', '钠lis_item_code，多个来源用逗号分隔', 1
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM "zing_doctor_db_prod"."config_apache2" WHERE "config_type"='lis_item' AND "config_key"='sodium');

INSERT INTO "zing_doctor_db_prod"."config_apache2"
    ("config_type", "config_key", "config_value", "item_name", "remark", "sort_no")
SELECT 'lis_item', 'potassium', '100140,5040', '血清钾', '钾lis_item_code，多个来源用逗号分隔', 2
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM "zing_doctor_db_prod"."config_apache2" WHERE "config_type"='lis_item' AND "config_key"='potassium');

INSERT INTO "zing_doctor_db_prod"."config_apache2"
    ("config_type", "config_key", "config_value", "item_name", "remark", "sort_no")
SELECT 'lis_item', 'creatinine', '100210', '血清肌酐', '肌酐lis_item_code，原单位μmol/L，评分时转mg/dL', 3
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM "zing_doctor_db_prod"."config_apache2" WHERE "config_type"='lis_item' AND "config_key"='creatinine');

INSERT INTO "zing_doctor_db_prod"."config_apache2"
    ("config_type", "config_key", "config_value", "item_name", "remark", "sort_no")
SELECT 'lis_item', 'hct', '200060', '血细胞比容', 'HCT lis_item_code', 4
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM "zing_doctor_db_prod"."config_apache2" WHERE "config_type"='lis_item' AND "config_key"='hct');

INSERT INTO "zing_doctor_db_prod"."config_apache2"
    ("config_type", "config_key", "config_value", "item_name", "remark", "sort_no")
SELECT 'lis_item', 'wbc', '200010', '白细胞', 'WBC lis_item_code', 5
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM "zing_doctor_db_prod"."config_apache2" WHERE "config_type"='lis_item' AND "config_key"='wbc');
